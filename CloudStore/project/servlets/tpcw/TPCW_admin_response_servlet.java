...
public class TPCW_admin_response_servlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		out.print("<H2 ALIGN=\"CENTER\"><IMG SRC=\"images/tpclogo.gif\""
		...
		if (I_NEW_COSTstr.length() == 0 || I_NEW_IMAGE.length() == 0
			...
			out.print("<BLOCKQUOTE><P><B>Suggested Retail: $"
					...
					+ I_NEW_COSTstr
					+ "</B></FONT><BR><B>You Save: </B><FONT "
					+ "COLOR=\"#DD0000\"><B>"
					+ Double.toString((book.i_srp - (Double
							.valueOf(I_NEW_COSTstr)).doubleValue()))
					+ "</B></FONT></P></BLOCKQUOTE> ");
			out.print("<P><FONT SIZE=\"2\">" + book.i_backing + ", "
					+ book.i_page + " pages<BR>\n");
