...
public class TPCW_buy_request_servlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		if (RETURNING_FLAG.equals("N")) {
			out.print("<TR><TD>USERNAME:</TD><TD>" + cust.c_uname
					+ "</TD></TR>\n");
		...
		out.print("<TR><TD><B>Subtotal with discount (" + cust.c_discount
				...
				+ "</B></TD></TR>\n");
		out.print("<TR><TD><B>Tax</B></TD><TD ALIGN=\"RIGHT\"><B>$"
				+ mycart.SC_TAX + "</B></TD></TR>\n");
		out.print("<TR><TD><B>Shipping &amp; Handling</B></TD><TD ALIGN=\"RIGHT\"><B>$"
				+ mycart.SC_SHIP_COST + "</B></TD></TR>\n");
		out.print("<TR><TD><B>Total</B></TD><TD ALIGN=\"RIGHT\"><B>$"
				+ mycart.SC_TOTAL + "</B></TD></TR></TABLE>\n");
		...
		out.print("<TR><TD>Credit Card Expiration Date (mm/dd/yyyy)</TD>\n");
