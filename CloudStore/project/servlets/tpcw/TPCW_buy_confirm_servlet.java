	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		if (!STREET_1.equals("")) {
			...
			result = TPCW_Database.doBuyConfirm(SHOPPING_ID, C_ID, CC_TYPE,
					CC_NUMBER, CC_NAME, new java.sql.Date(CC_EXPIRY.getTime()),
		...
		for (i = 0; i < result.cart.lines.size(); i++) {
			...
			out.print("<TD VALIGN=\"TOP\">Title:<I>" + line.scl_title
					+ "</I> - Backing: " + line.scl_backing + "<BR>SRP. $"
					+ line.scl_srp + "<FONT COLOR=\"#aa0000\"><B>Your Price: $"
		...
		out.print("<TD><H4>$" + result.cart.SC_TOTAL
				+ "</H4></TD></TR></TABLE>\n");
