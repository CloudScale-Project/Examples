...
public class TPCW_product_detail_servlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		out.print("<CENTER><IMG SRC=\"images/tpclogo.gif\""
		...
		out.print("<P>Author: " + mybook.a_fname + " " + mybook.a_lname
				+ "<BR>\n");
		out.print("Subject: " + mybook.i_subject + "\n");
		out.print("<P><IMG SRC=images/"
				+ mybook.i_image
				+ " ALIGN=\"RIGHT\" BORDER=\"0\" WIDTH=\"200\" HEIGHT=\"200\">\n");
		out.print("Decription: <I>" + mybook.i_desc + "</I></P>\n");
		out.print("<BLOCKQUOTE><P><B>Suggested Retail: " + mybook.i_srp
				+ "</B>\n");
		...
		out.print("<IMG SRC=\"images/add_B.gif\""
				+ " ALT=\"Add to Basket\"></A>\n");
		...
		out.print("<A HREF=\"" + res.encodeUrl(url));
		out.print("\"><IMG SRC=\"images/update_B.gif\""
				+ " ALT=\"Update\"></A>\n");
