...
<specification:PSCatalog xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
  ...
  <patternSpecifications id="_8u6OgPVhEeOgbJdIqiztvw" name="AcquireReleasePair">
    <connections xsi:type="specification:PSLink" id="_VF19IPViEeOgbJdIqiztvw" name="link1"
        source="#_-WpBUPVhEeOgbJdIqiztvw" target="#_LWXAEPViEeOgbJdIqiztvw" instanceOf="http://palladiosimulator.org/PalladioComponentModel/5.0#//seff/ResourceDemandingBehaviour/steps_Behaviour"/>
    <connections xsi:type="specification:PSLink" id="_V51l4PViEeOgbJdIqiztvw" name="link2"
        source="#_-WpBUPVhEeOgbJdIqiztvw" target="#_LrRgIPViEeOgbJdIqiztvw" instanceOf="http://palladiosimulator.org/PalladioComponentModel/5.0#//seff/ResourceDemandingBehaviour/steps_Behaviour"/>
    <connections xsi:type="specification:PSLink" id="_nlJKAPViEeOgbJdIqiztvw" name="link3"
        source="#_LrRgIPViEeOgbJdIqiztvw" target="#_jVVhsPViEeOgbJdIqiztvw" instanceOf="http://palladiosimulator.org/PalladioComponentModel/5.0#//seff/ReleaseAction/passiveResource_ReleaseAction"/>
    <connections xsi:type="specification:PSLink" id="_oHb-wPViEeOgbJdIqiztvw" name="link4"
        source="#_LWXAEPViEeOgbJdIqiztvw" target="#_jVVhsPViEeOgbJdIqiztvw" instanceOf="http://palladiosimulator.org/PalladioComponentModel/5.0#//seff/AcquireAction/passiveresource_AcquireAction"/>
    ...
    <connections xsi:type="specification:PSLink" id="_Ao5W0PVtEeOhXMVyYRdIxA" name="link8"
        source="#_bXgj8PVsEeOhXMVyYRdIxA" target="#_-WpBUPVhEeOgbJdIqiztvw" instanceOf="http://palladiosimulator.org/PalladioComponentModel/5.0#//repository/BasicComponent/serviceEffectSpecifications__BasicComponent"/>
    ...
    <nodes xsi:type="specification:PSObject" id="_-WpBUPVhEeOgbJdIqiztvw" name="behaviour"
        ...
        instanceOf="http://palladiosimulator.org/PalladioComponentModel/5.0#//seff/ResourceDemandingSEFF"/>
    <nodes xsi:type="specification:PSObject" id="_LWXAEPViEeOgbJdIqiztvw" name="acquireAction"
        ...
        instanceOf="http://palladiosimulator.org/PalladioComponentModel/5.0#//seff/AcquireAction"/>
    <nodes xsi:type="specification:PSObject" id="_LrRgIPViEeOgbJdIqiztvw" name="releaseAction"
        ...
        instanceOf="http://palladiosimulator.org/PalladioComponentModel/5.0#//seff/ReleaseAction"/>
    <nodes xsi:type="specification:PSObject" id="_jVVhsPViEeOgbJdIqiztvw" name="passiveResource"
        incoming="#_nlJKAPViEeOgbJdIqiztvw #_oHb-wPViEeOgbJdIqiztvw" instanceOf="http://palladiosimulator.org/PalladioComponentModel/5.0#//repository/PassiveResource"/>
    ...
    <nodes xsi:type="specification:PSObject" id="_bXgj8PVsEeOhXMVyYRdIxA" name="primitiveComponent"
        outgoing="#_Ao5W0PVtEeOhXMVyYRdIxA" incoming="#_iBGuIPVsEeOhXMVyYRdIxA" instanceOf="http://palladiosimulator.org/PalladioComponentModel/5.0#//repository/BasicComponent"/>
  ...
  <patternSpecifications id="_7E0R8PVmEeO8apkjJxxSYA" name="FindPrimitiveComponents">
    ...
    <nodes xsi:type="specification:PSObject" id="_WLDqAPVoEeO8apkjJxxSYA" name="primitiveComponent"
        incoming="#_BdcOoPVsEeOhXMVyYRdIxA #_EKcAYPVsEeOhXMVyYRdIxA" instanceOf="http://palladiosimulator.org/PalladioComponentModel/5.0#//repository/BasicComponent"/>
  </patternSpecifications>
  ...
  <patternSpecifications id="_PFOU0PbeEeOeYJP9coicjQ" name="FindClasses">
    ...
    <nodes xsi:type="specification:PSObject" id="_P-e4EPbeEeOeYJP9coicjQ" name="obj1"
        instanceOf="http://palladiosimulator.org/PalladioComponentModel/5.0#//seff/CallAction"/>
  </patternSpecifications>
